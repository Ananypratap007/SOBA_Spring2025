...
class _CompleteSignupScreenState extends State<CompleteSignupScreen> {
  ...
  final _affiliatedOrgController = TextEditingController();
...
// Function to pick image from gallery
  ...
  Future<void> _handleCompleteSignup() async {
    ...
    try {
      ...
      // Update existing doc with more fields
      await FirebaseFirestore.instance.collection('users').doc(uid).update({
        'affiliatedOrg': _affiliatedOrgController.text.trim().toLowerCase(),
        'role': _roleController.text.trim().toLowerCase(),
        'race': _raceController.text.trim().toLowerCase(),
        'gender': _genderController.text.trim().toLowerCase(),
        'eyeColor': _eyeColorController.text.trim().toLowerCase(),
        'hairColor': _hairColorController.text.trim().toLowerCase(),
        'height': _heightController.text.trim().toLowerCase(),
        'weight': _weightController.text.trim().toLowerCase(),
        // If you have age:
        'age': _ageController.text.trim().toLowerCase(),
        'profileCompleted': true
      });

      // If you want to store the profile picture, upload to Firebase Storage
      ...
      // Once complete, you can navigate away:
      if (mounted) {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TextField(
                controller: _affiliatedOrgController,
